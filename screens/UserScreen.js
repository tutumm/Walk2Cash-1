      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={{ flexDirection: 'row', margin: 30 }}>
          ...
          <View style={{ justifyContent: 'center' }}>
            <Text style={{ color: 'white', fontSize: 16, fontWeight: 'bold' }}>{this.props.username}</Text>
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
          ...
          <View style={styles.sortGraph}>
            ...
            <View style={this.state.pressStatusDay ? styles.buttonPress : styles.welcome}>
              <Text style={{ backgroundColor: 'transparent', textAlign: 'center', color: 'white' }} onPress={this.onPressDay}>
                Day</Text>
            </View>
            <View style={this.state.pressStatusWeek ? styles.buttonPress : styles.welcome}>
              <Text style={{ backgroundColor: 'transparent', textAlign: 'center', color: 'white' }} onPress={this.onPressWeek}>
                Week</Text>
            </View>
            <View style={this.state.pressStatusMonth ? styles.buttonPress : styles.welcome}>
              <Text style={{ backgroundColor: 'transparent', textAlign: 'center', color: 'white' }} onPress={this.onPressMonth}>
                Month</Text>
            </View>
            <View style={this.state.pressStatusYear ? styles.buttonPress : styles.welcome}>
              <Text style={{ backgroundColor: 'transparent', textAlign: 'center', color: 'white' }} onPress={this.onPressYear}>
                Year</Text>
            </View>
